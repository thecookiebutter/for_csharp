...
## Descrição do projeto
Este é um programa simples em C# que imprime números pares. O usuário pode inserir um número, e o código imprime uma quantidade de números pares igual a esse número.

## Funcionalidades ⚙️
✔️ Funcionalidade 1
  Imprime os primeiros X números pares, sendo X da escolha do usuário.
